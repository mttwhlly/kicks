...
// routes/organization.$id.error.tsx
...
type Module = typeof import("../organization.$id.error.js")

export type Info = {
  parents: [Parent0, Parent1],
  id: "routes/organization.$id.error"
  file: "routes/organization.$id.error.tsx"
  path: "error"
