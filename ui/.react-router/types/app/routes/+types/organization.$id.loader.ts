...
// routes/organization.$id.loader.ts

import type * as T from "react-router/route-module"

import type { Info as Parent0 } from "../../+types/root.js"
import type { Info as Parent1 } from "./organization.$id.js"

type Module = typeof import("../organization.$id.loader.js")

export type Info = {
  parents: [Parent0, Parent1],
  id: "routes/organization.$id.loader"
  file: "routes/organization.$id.loader.ts"
  path: "loader"
