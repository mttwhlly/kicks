...
export default function Content() {
  return (
    <>
      <Box className='flex justify-between max-w-6xl mx-auto mt-[120px]'>
        <Box className='flex-1 text-4xl py-6 px-4 leading-tight'>Make <span className='font-bold'>Better</span> Decisions about your care with <span className='font-bold'>Verified</span> Provider & Directory Data</Box>
